...
try:
    from .motmetrics_uto.metrics import MetricsHost
    from .motmetrics_uto.metrics import MetricsHost
...
import sys
sys.path.append("...")
from eval.tracking.data_classes import TrackingMetrics
from eval.tracking.metrics import motar, mota_custom, motp_custom, faf, track_initialization_duration, longest_gap_duration, num_fragmentations_custom
...
def create_motmetrics() -> MetricsHost:
    ...
    for field in fields:
        mh.register(getattr(Mmetrics, field), formatter='{:d}'.format)
