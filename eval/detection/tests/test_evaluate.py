...
from ....eval.detection.constants import DETECTION_NAMES
from ....eval.detection.evaluate import DetectionEval
from ....eval.detection.utils import category_to_detection_name, detection_name_to_rel_attributes
