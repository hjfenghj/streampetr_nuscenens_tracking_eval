...
from ...eval.common.data_classes import EvalBoxes
from ...eval.common.render import setup_axis
from ...eval.common.utils import boxes_to_sensor
from ...eval.detection.constants import TP_METRICS, DETECTION_NAMES, DETECTION_COLORS, TP_METRICS_UNITS, \
    PRETTY_DETECTION_NAMES, PRETTY_TP_METRICS
from ...eval.detection.data_classes import DetectionMetrics, DetectionMetricData, DetectionMetricDataList
